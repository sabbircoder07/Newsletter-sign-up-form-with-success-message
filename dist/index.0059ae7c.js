...
})({"klTFg":[function(require,module,exports) {
...
var _confiJs = require("./confi.js");
var _signupViewJs = require("./view/signupView.js");
var _signupViewJsDefault = parcelHelpers.interopDefault(_signupViewJs);
const controlSignup = function(newSignup) {
    try {
        _modelJs.signup(newSignup);
        (0, _signupViewJsDefault.default).renderEmailAddress(_modelJs.state.signupInformation.emailID);
        (0, _signupViewJsDefault.default)._clearErrorMessage();
        (0, _signupViewJsDefault.default).showMessageContainer();
        setTimeout(function() {
            (0, _signupViewJsDefault.default).hideMessageContainer();
        }, _confiJs.TIMEOUT_SECOND * 1000);
        (0, _signupViewJsDefault.default).startInterVal();
    } catch (error) {
        (0, _signupViewJsDefault.default).renderError(error.message);
        setTimeout(function() {
            (0, _signupViewJsDefault.default)._clearErrorMessage();
        }, _confiJs.MESSAGE_CLOSE_SEC * 1000);
    }
};
...
const init = function() {
    ...
    (0, _signupViewJsDefault.default).addHandlerDismiss(controlDismissMessage);
};
init();

},{"./model.js":"dkYPG","./confi.js":"3Wbdh","./view/signupView.js":"lPiX2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dkYPG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const signup = function(newSignup) {
    try {
        ...
        if (emailID) {
            if (emailID.match(regex)) {
                ...
                state.signupInformation.id = (0, _uuid.v4)();
                state.signupInformation.emailID = newSignup.emailID;
            } else throw new Error("Please Enter a Valid Email Address.");
        } else throw new Error("Please Enter a Valid Email Address.");
    } catch (error) {
        throw error;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Wbdh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TIMEOUT_SECOND", ()=>TIMEOUT_SECOND);
parcelHelpers.export(exports, "MESSAGE_CLOSE_SEC", ()=>MESSAGE_CLOSE_SEC);
const TIMEOUT_SECOND = 11;
const MESSAGE_CLOSE_SEC = 10;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lPiX2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _confiJs = require("../confi.js");
class SignupView extends (0, _viewJsDefault.default) {
    ...
    _successMessageContainer = document.querySelector(".success-message-container");
...
},{"./view.js":"eF7YH","../confi.js":"3Wbdh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eF7YH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconErrorSvg = require("../../../assets/images/icon-error.svg");
var _iconErrorSvgDefault = parcelHelpers.interopDefault(_iconErrorSvg);
var _confiJs = require("../confi.js");
class view {
    intervalId;
    ...
    showMessageContainer() {
        ...
        this._email.value = "";
        this.cuntdown.textContent = _confiJs.MESSAGE_CLOSE_SEC;
        this._email.classList.remove("invalid-email-id");
    }
    ...
    renderError(message = this._errorMessage) {
        const murkup = `
    <img class="error-icon" src="${(0, _iconErrorSvgDefault.default)}" alt="error icon">
    <p>${message}</p>`;
...
},{"../../../assets/images/icon-error.svg":"3s8Je","../confi.js":"3Wbdh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3s8Je":[function(require,module,exports) {
module.exports = require("4a7a774341ebc0").getBundleURL("7tDcp") + "icon-error.902ac956.svg" + "?" + Date.now();

},{"4a7a774341ebc0":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["klTFg","2dUup"], "2dUup", "parcelRequire6ed1")
